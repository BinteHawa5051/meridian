    ...
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="bg-[#141416] border border-[#27272a] rounded-2xl p-8 shadow-2xl">
          ...
          <p className="text-sm text-[#71717A] mb-6">Start controlling your AI costs</p>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="text-[11px] text-[#A1A1AA] mb-1.5 block">Full Name</label>
              <Input
                placeholder="Tooba Akram"
                value={form.name}
            ...
            <div>
              <label className="text-[11px] text-[#A1A1AA] mb-1.5 block">Organisation Name</label>
              <Input
            ...
            <Button variant="primary" size="md" type="submit" disabled={loading} className="w-full h-10">
          ...
          <p className="text-center text-xs text-[#71717A] mt-6">
            ...
            <Link href="/login" className="text-[#A52D4F] hover:text-[#7A1F34] transition-colors">
              Sign in
            </Link>
          </p>
        </div>
